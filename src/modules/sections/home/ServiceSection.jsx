...
function ServicesSection() {
  return (
    <section className="bg-[#2e2a2a] text-white py-20">
      <div className="max-w-7xl mx-auto px-6 lg:px-20 flex flex-col lg:flex-row items-center gap-10">
        
        {/* Left Side: Text Content */}
        <div className="lg:w-1/2 space-y-6">
          <h2 className="text-3xl md:text-4xl font-extrabold">
            TAILORED <span className="text-yellow-400">LIGHTNING-SPEED</span> SOLUTIONS FOR EVERY BUSINESS
          </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6">
            <p className="flex items-center gap-2"><FaCheckCircle className="text-yellow-400"/> LEAD GENERATION</p>
            <p className="flex items-center gap-2"><FaCheckCircle className="text-yellow-400"/> LIFE INSURANCE SALES</p>
            <p className="flex items-center gap-2"><FaCheckCircle className="text-yellow-400"/> INBOUND CUSTOMER SERVICES</p>
            <p className="flex items-center gap-2"><FaCheckCircle className="text-yellow-400"/> OUTBOUND CUSTOMER SERVICES</p>
          </div>

          {/* Call-to-Action */}
          <button className="mt-6 bg-yellow-400 hover:bg-yellow-500 text-black font-semibold px-8 py-3 rounded-full transition duration-300">
        ...
        <div className="lg:w-1/2 relative">
          ...
          <div className="absolute bottom-4 left-4 bg-gray-800 border border-yellow-400 rounded-lg p-4 flex items-start gap-3 max-w-xs">
            <FaBolt className="text-yellow-400 text-xl mt-1" />
