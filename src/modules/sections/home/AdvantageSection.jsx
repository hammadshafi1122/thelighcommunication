...
export const AdvantageSection = () => {
  return (
    <section className="bg-[#2e2a2a] text-white py-16">
      <div className="container mx-auto flex flex-col md:flex-row items-center gap-8 px-4">
        ...
        <div className="md:w-1/2">
          ...
          <button className="bg-yellow-500 text-gray-900 font-semibold px-6 py-2 rounded-lg hover:bg-yellow-600 transition">
            Learn More About Us
          </button>
        </div>
      </div>
